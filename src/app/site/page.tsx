...
export default function Home() {
	return (
		<>
			<section className="min-h-screen w-full pt-44 mt-[-70px]  flex items-center justify-center flex-col ">
				{/* grid */}
				...
				<div className="flex justify-center items-center  md:mt-[-70px] relative">
					<Image
